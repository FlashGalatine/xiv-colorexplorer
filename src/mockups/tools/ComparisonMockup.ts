    ...
    plot.innerHTML = `
      <svg viewBox="0 0 120 120" class="w-full h-full">
        ...
        <g transform="translate(16, 4)">
          ...
          <text x="0" y="112" text-anchor="middle" font-size="4" fill="var(--theme-text-muted)">0°</text>
          <text x="25" y="112" text-anchor="middle" font-size="4" fill="var(--theme-text-muted)">90°</text>
          <text x="50" y="112" text-anchor="middle" font-size="4" fill="var(--theme-text-muted)">180°</text>
