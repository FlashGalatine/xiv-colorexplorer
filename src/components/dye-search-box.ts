...
export class DyeSearchBox extends BaseComponent {
    ...
    bindEvents(): void {
        ...
        const clearBtn = this.querySelector<HTMLButtonElement>('button[aria-label="' + LanguageService.t('dyeSelector.clearAriaLabel') + '"]');
        ...
        catBtns.forEach((btn) => {
            this.on(btn, 'click', () => {
                ...
                catBtns.forEach(b => {
                    ...
                    b.classList.add('border', 'border-gray-300', 'dark:border-gray-600', 'text-gray-700', 'dark:text-gray-300', 'hover:bg-gray-100', 'dark:hover:bg-gray-700');
                });
    ...
    public getSortOption(): SortOption { return this.sortOption; }
    public getCategory(): string | null { return this.currentCategory; }
